      ...
      <article className="panel">
        ...
        <div className="cards">
          ...
          {data.courses.map((course) => (
            <CourseCard key={course.id} course={course} editing={editing} />
          ))}
        </div>
...
// ============================================================
// Course card (own component: hooks must not live inside .map())
// ============================================================

function CourseCard({ course, editing }: { course: Course; editing: boolean }) {
  const { state, updateCourse, deleteCourse } = useAppContext();
  const { data } = state;
